...
func setup() (string, func()) {
	...
	mux.HandleFunc(
		"/topstories.json", func(w http.ResponseWriter, r *http.Request) {
	...
	mux.HandleFunc(
		"/item/", func(w http.ResponseWriter, r *http.Request) {
			fmt.Fprint(
				w,
				"{\"by\":\"test_user\",\"descendants\":10,\"id\":1,\"kids\":[16732999,16729637,16729517,16729595],\"score\":34,\"time\":1522599083,\"title\":\"Test Story Title\",\"type\":\"story\",\"url\":\"https://www.test-story.com\"}",
			)
		},
	)
