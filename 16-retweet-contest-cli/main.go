...
import (
	...
	"16-retweet-contest-cli/twitter"
)
...
func main() {
	...
	flag.StringVar(
		...
		"key",
		".keys.json",
		"The file where you store your consumer key and secret for the Twitter API.",
	)
	flag.StringVar(
		&usersFile,
		"users",
		"users.csv",
		"The file where users who have retweeted the tweet are stored. This will be created if it does not exist.",
	)
	flag.StringVar(
		&tweetID,
		"tweet",
		"991053593250758658",
		"The ID of the Tweet you wish to find retweeters of.",
	)
